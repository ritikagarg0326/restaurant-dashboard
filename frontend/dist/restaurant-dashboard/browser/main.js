...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-X3V4AQGM.js").then((m) => m.LoginComponent)
  },
  {
    path: "admin",
    canActivate: [authGuard, roleGuard],
    data: { role: "admin" },
    loadComponent: () => import("./chunk-DZZXC5JH.js").then((m) => m.AdminShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-QJ5J4KLV.js").then((m) => m.AdminDashboardComponent) },
      { path: "restaurants", loadComponent: () => import("./chunk-PX5VQQMS.js").then((m) => m.RestaurantsComponent) },
      { path: "users", loadComponent: () => import("./chunk-LIZFW5V5.js").then((m) => m.UsersComponent) }
    ]
  },
  {
    path: "manager",
    canActivate: [authGuard, roleGuard],
    data: { role: "manager" },
    loadComponent: () => import("./chunk-DK3V4QCP.js").then((m) => m.ManagerShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-EEJJQUWH.js").then((m) => m.ManagerDashboardComponent) },
      { path: "orders", loadComponent: () => import("./chunk-XEH2BS6X.js").then((m) => m.OrdersComponent) },
      { path: "inventory", loadComponent: () => import("./chunk-L7XP6AR5.js").then((m) => m.InventoryComponent) },
      { path: "wastage", loadComponent: () => import("./chunk-KXZI4VF5.js").then((m) => m.WastageComponent) },
      { path: "expenses", loadComponent: () => import("./chunk-GG6FW4NQ.js").then((m) => m.ExpensesComponent) }
    ]
  },
