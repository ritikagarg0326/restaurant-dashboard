...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-3WED4VA4.js").then((m) => m.LoginComponent)
  },
  {
    path: "admin",
    canActivate: [authGuard, roleGuard],
    data: { role: "admin" },
    loadComponent: () => import("./chunk-TAVYXLRH.js").then((m) => m.AdminShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-S3ZUJFIK.js").then((m) => m.AdminDashboardComponent) },
      { path: "restaurants", loadComponent: () => import("./chunk-OXI7LCFE.js").then((m) => m.RestaurantsComponent) },
      { path: "users", loadComponent: () => import("./chunk-YF4DEGZA.js").then((m) => m.UsersComponent) }
    ]
  },
  {
    path: "manager",
    canActivate: [authGuard, roleGuard],
    data: { role: "manager" },
    loadComponent: () => import("./chunk-5QRZU3IU.js").then((m) => m.ManagerShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-ZNXO7LXF.js").then((m) => m.ManagerDashboardComponent) },
      { path: "orders", loadComponent: () => import("./chunk-V7XMEIES.js").then((m) => m.OrdersComponent) },
      { path: "inventory", loadComponent: () => import("./chunk-I7P7H4I4.js").then((m) => m.InventoryComponent) },
      { path: "wastage", loadComponent: () => import("./chunk-MZEZHHPB.js").then((m) => m.WastageComponent) },
      { path: "expenses", loadComponent: () => import("./chunk-5E4QTUAB.js").then((m) => m.ExpensesComponent) }
    ]
  },
